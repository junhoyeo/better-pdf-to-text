...
pdf-extract is a robust PDF text extraction library that combines Rust and Python extraction methods with automatic fallback. It's structured as a Yarn workspace monorepo with three packages:
